...
namespace gadpime {
    ...
    public partial class ClientSearchWindow {
        ...
        protected virtual void Build() {
            ...
            // Widget gadpime.ClientSearchWindow
            ...
            this.Name = "gadpime.ClientSearchWindow";
            this.Title = Mono.Unix.Catalog.GetString("ClientSearchWindow");
            ...
            this.ButtonClientSave.Label = "gtk-find";
            ...
            Gtk.Box.BoxChild w14 = ((Gtk.Box.BoxChild)(this.vbox1[this.vbox2]));
            w14.Position = 1;
            w14.Expand = false;
            w14.Fill = false;
            this.Add(this.vbox1);
            ...
            this.ButtonClientSave.Clicked += new System.EventHandler(this.ClientSearch);
